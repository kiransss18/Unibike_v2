                                ...
                                <div class="col-md-6 p-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            id="seri" name="seri" value="<?= $bike['seri'] ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            <?php for ($year = 2019; $year <= 2025; $year++) { ?>
                                                <option value="<?= $year ?>" <?php if (isset($bike['tahun']) && $bike['tahun'] == $year)
                                                      echo 'selected'; ?>>
                                                    <?= $year ?>
                                                </option>
                                            <?php } ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php if (isset($_POST['submit']) && session('errors.foto')): ?>
                                            <div class="text-danger"><?= session('errors.foto') ?></div>
                                        <?php endif ?>
                                    </div>
                                </div>
